...
if(!class_exists('MoMo_Qr_Payment_GateWay_Controller')){
    ...
    class MoMo_Qr_Payment_GateWay_Controller extends WC_Payment_Gateway {
        function __construct ()
        {
            ...
            add_action( 'woocommerce_api_momo_qr_ipn', [$this, 'webhook_api_momo_qr_ipn'] );
            add_action( 'woocommerce_api_momo_qr_redirect_url', [$this, 'webhook_api_momo_qr_redirect_url'] );
        ...
        * Redirect Webhook
        */
        function webhook_api_momo_qr_redirect_url() {
