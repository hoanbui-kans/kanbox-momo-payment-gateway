...
if(!class_exists('MoMo_Atm_Payment_GateWay_Controller')){
    ...
    class MoMo_Atm_Payment_GateWay_Controller extends WC_Payment_Gateway {
        ...
        function __construct ()
        {
            ...
            $this->icon =  KANBOX_MOMO_URL . 'assets/logo-atm.png'; // URL of the icon that will be displayed on checkout page near your gateway name
        ...
        */
        ...
        {
            $this->form_fields = include( KANBOX_MOMO_DIR . 'inc/settings/momo-atm-settings.php');
        }
        ...
        */
        public function payment_fields() {
            ...
            if ( $this->description ) {
               ...
               ?>
               <p><?php esc_attr_e('Thanh toán trực tuyến bằng mã quét momo, xin vui lòng sử dụng App', 'kanbox');?> <a href="https://referral.momo.vn/ref/MDkwMzg4ODc4MSZndGJiMjAyMg==/referral_others">
                <?php esc_attr_e('ví điện tử MoMo', 'kanbox');?></a> <?php esc_attr_e('để thanh toán miễn phí', 'kanbox');?></p>
               <?php
            }
        }
